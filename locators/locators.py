...
class PageLocators:
    ...
    # BLOCK_ELEMENTS = (By.XPATH, "//div[contains(@class, 'tensor_ru-Index__block4-content')]")
    ...
    PODROBNEE_BUTTON = (By.CSS_SELECTOR, "div.tensor_ru-Index__block4-content > p.tensor_ru-Index__card-text > a.tensor_ru-link")
    RABOTAEM_LINK = (By.LINK_TEXT, "Rabotaem")
    PHOTOS_LINK = (By.CSS_SELECTOR, ".tensor_ru-About__block3-image.new_lazy.loaded")  # Здесь группа из четырех изображений

    REGION_NAME = (By.CLASS_NAME, "sbis_ru-Region-Chooser__text") #Проверка региона туда же клик
    PARTNERS_LINK = (By.XPATH, '//div[@class="sbisru-Contacts-List__city" and text()="Казань"]') #Проверка партнера
    REGION_CHOICE = (By.XPATH, '//span[@title="Камчатский край" and text()="41 Камчатский край"]') #Выбор региона
    REGION_NAME_UPDATED = (By.XPATH, '//span[@class="sbis_ru-Region-Chooser__text" and text()="Камчатский край"]') #Новое имя региона
